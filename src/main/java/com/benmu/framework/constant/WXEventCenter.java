...
public class WXEventCenter {
    ...
    public static final String EVENT_TOWEBVIEW = "com.benmu.framework.event.router.EventWebView";
    public static final String EVENT_CALL = "com.benmu.framework.event.router.EventCall";
